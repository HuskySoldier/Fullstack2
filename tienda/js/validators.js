// Validators (email domains, password length, etc.)
...
function validateRegistro(form){
  ...
  if(!EMAIL_OK.test(email.value.trim())){ setError(email,'Dominio permitido: duoc.cl, profesor.duoc.cl, gmail.com'); ok=false;} else setError(email,'');
